    ...
    public class ReadmeEditor : UnityEditor.Editor
    {
        ...
        static void LoadLayout()
        {
            ...
            if (method != null)
            {
                ...
                {
                    Debug.LogWarning($"ReadmeEditor: Failed to load layout via reflection: {ex.Message}");
                }
            }
         }
        ...
        GUIStyle LinkStyle => mLinkStyle;

        [SerializeField]
        GUIStyle mLinkStyle;

        GUIStyle TitleStyle => mTitleStyle;

        [SerializeField]
        GUIStyle mTitleStyle;

        GUIStyle HeadingStyle => mHeadingStyle;

        [SerializeField]
        GUIStyle mHeadingStyle;

        GUIStyle BodyStyle => mBodyStyle;

        [SerializeField]
        GUIStyle mBodyStyle;

        GUIStyle ButtonStyle => mButtonStyle;
