...
{
    /// <summary>
    /// Attach to objects that can be broken by `MeshDestrroy` or other systems.
    /// If `fracturedPrefab` is assigned, that prefab will be instantiated and its Rigidbodies will be kicked.
    /// Otherwise a simple runtime fracture is generated using primitive fragments.
    /// </summary>
    ...
    public class BreakableObject : MonoBehaviour
    {
        ...
        /// <summary>
        /// Break the object at a given point with an optional incoming velocity. If fracturedPrefab is set, instantiate that;
        /// otherwise create primitive fragments at runtime.
        /// </summary>
        /// <param name="impactPoint">World-space impact point</param>
        /// <param name="incomingVelocity">Velocity of the object at impact</param>
        /// <param name="forceMultiplier">Multiplier applied to explosionForce</param>
